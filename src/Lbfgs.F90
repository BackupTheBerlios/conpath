!================    L-BFGS-B (version 2.1)   ==========================
      ...
      double precision :: wa(2*m*n+4*n+12*m*m+12*m), dsave(29)
...
!
      ...
      integer   lsgo,lwy,lsy,lss,lyy,lwt,lwn,lsnd,lygo
...
!
      ...
      integer      ::  nint,nfgv,info,ifun
      integer      ::  iword,nfree,nact,ileave,nenter
      double precision  ::  theta,fold,ddot,dr,rr,tol,dpmeps
      double precision  ::  xstep,sbgnrm,ddum,dnorm,dtd,epsmch
      double precision  ::  cpu1,cpu2,cachyt,sbtime,lnscht,time1,time2
...
!
      ...
      double precision  :: x(n), l(n), u(n), g(n), t(n), d(n), xcp(n)
      double precision  :: sg(m), yg(m), wy(n, col), ws(n, col), sy(m, m)
...
!
      ...
      double precision :: tu,tl,wmc,wmp,wmw,ddot,tj,tj0,neggi,sbgnrm,f2_org
      double precision, parameter :: one=1.0d0, zero=0.0d0
!
...
!
      ...
      double precision :: x(n), g(n), z(n), r(n), wa(4*m)
...
!
      ...
      double precision ::  stpmx, x(n), l(n), u(n), g(n), d(n), r(n), t(n)
      double precision ::  z(n), dsave(13)
...
!
      ...
      double precision, parameter  :: one=1.0d0, zero=0.0d0, big=1.0d+10
      double precision, parameter  :: ftol=1.0d-3, gtol=0.9d0, xtol=0.1d0
...
!
      ...
      if (iprint .ge. 1) write (itfile,3001) iter,nfgv,nint,nact,word,iback,stp,xstep,sbgnrm,f
...
!
      ...
      integer          :: nskip, nact, nint, iback, k
      double precision :: f, sbgnrm, time, stp, xstep, cachyt, sbtime
      double precision :: lnscht, x(n)
...
!
      ...
      double precision ::  theta
      double precision ::  l(n), u(n), x(n), d(n)
...
!
      ...
      double precision, parameter :: zero=0.0d0,p5=0.5d0,p66=0.66d0
      double precision, parameter :: xtrapl=1.1d0,xtrapu=4.0d0

      logical :: brackt
      integer :: stage
      double precision :: finit,ftest,fm,fx,fxm,fy,fym,ginit,gtest
      double precision :: gm,gx,gxm,gy,gym,stx,sty,stmin,stmax,width,width1
!
...
!
      ...
      double precision,parameter :: zero=0.0d0,p66=0.66d0,two=2.0d0,three=3.0d0
